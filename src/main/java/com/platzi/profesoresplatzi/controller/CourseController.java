...
public class CourseController {
	...
	public ResponseEntity<?> deleteCourse(@PathVariable("id") Long id){
		...
		Course course = _courseService.findById(id);
		if (course == null) {
			System.out.println("ID not found. Unable to delete course with id: " + id);
			return new ResponseEntity(new CustomErrorType("Unable to delete"), HttpStatus.NOT_FOUND);
		}
